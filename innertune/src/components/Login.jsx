        ...
        <div>
          ...
          <div className="mt-8 ">
            ...
            <div className="mt-8 flex flex-col gap-y-4 ">
              <button className="active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] ease-in-out cursor-pointer py-3 rounded-xl  bg-violet-500 text-white text-lg font-semibold">
                Login in
              </button>
